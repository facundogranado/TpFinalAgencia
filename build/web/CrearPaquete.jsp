        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <table class="table" >
                    ...
                    <tbody>
                    <form action="svPaquete" method="POST" class="formulario" style="width: 100%;position: relative; display: block">
                        <%
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="id" value="<%=servicio.getCodigo_servicio()%>"> 
                                </div>                     
                            </td>
                        </tr>
                        <%}%>
                ...
                <button type="submit" class="btn btn-primary" style="width: 10%; margin-left: 150px">Crear Paquete</button>
