...
<html lang="en">
    ...
    <body>
                ...
                <div class="sidebar">
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li><a href="#">Venta de Servicios</a></li>
        ...
        <div class="otro" style="margin-left: 275px; position: relative">
            ...
            <form action="svVenta" class="formulario" style="width: 100%" method="POST">
                <div class=" mb-3">
                    <label >Servicio Turistico</label>
                    <select id="inputState" class="form-select" name="servicioTuristico" style="width: 300px" required>
                ...
                <div class=" mb-3">
                    ...
                    <select id="inputState" class="form-select" style="width: 300px" name="metodoPago" required>
                        <option selected value="">Elegir...</option>
